...
const UnocoinApi = new Lang.Class({
  Name: 'UnocoinApi',
  Extends: BaseApi,
  ...
  getLabel: function (options) {
    return "Unocoin " + options.currency;
  },

  getUrl: function (options) {
    return "https://www.unocoin.com/trade?buy";
  }
});


const CoinsecureApi = new Lang.Class({
  Name: 'CoinsecureApi',
  Extends: BaseApi,
  ...
  attributes: {
    last: function (options) {
      ...
      return {
        text: function (data)
          renderCurrency(find(data)),
        change: function (data)
          renderChange(find(data))
      };
      return {
        text: function (data)
          renderCurrency(data),
  ...
  getLabel: function (options) {
    return "Coinsecure" + options.currency;
  },
...
const ApiProvider = new Lang.Class({
  ...
  _init: function () {
    this.apis = {
      ...
      unocoin: new UnocoinApi(),
      coinsecure: new CoinsecureApi()
    };
  },
